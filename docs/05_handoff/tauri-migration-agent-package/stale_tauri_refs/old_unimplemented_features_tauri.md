...
> **[廃止済み — 参照専用]**  
> 本文書は廃止された Tauri 移植版を前提とした残件表です。  
> 現行 PySide6 本線の残タスク管理には **[01_remaining-tasks.md](../03_planning/01_remaining-tasks.md)** を使用してください。  
> 本文書に記載されていた P0 項目（Persistent Mask Track・検出区間外編集・auto fallback・manual anchor 継承・タイムラインズーム等）は、現行 main に実装済みであることが 2026-04-09 の実装監査で確認されています。
